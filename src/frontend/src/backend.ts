...
export class Backend implements backendInterface {
    ...
    async getArtworksByUser(arg0: Principal): Promise<Array<string>> {
        if (this.processError) {
            try {
...
async function from_candid_tuple_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _Artwork]): Promise<[string, Artwork]> {
    return [
        value[0],
...
async function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _Artwork]>): Promise<Array<[string, Artwork]>> {
